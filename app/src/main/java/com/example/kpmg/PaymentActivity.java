...
public class PaymentActivity extends AppCompatActivity  implements PaymentResultWithDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.P1back);
        name2 = findViewById(R.id.P1name);
        ...
        buy = findViewById(R.id.paybtn1);

        address = findViewById(R.id.Paddress1);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (name2.getText().toString().equals("") || address.getText().toString().equals("")) {
                    Toast.makeText(PaymentActivity.this, "Enter All details", Toast.LENGTH_LONG).show();
                } else {
                    makepayment();
                }
            }
    ...
    private void makepayment() {
       // total=getIntent().getIntExtra("Bill",1);
        ...
        String t= getIntent().getStringExtra("Bill");
